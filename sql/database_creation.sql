...
-- Adding data into customer table for sample data test
...
VALUES 
    ('Christopher', 'Jones', 'christopherjones@bp.com', 'BP', '347 Cedar St', 'Lawrenceville', 
    'GA', '30044', '348-848-8291', '1938-09-11', 'M', current_timestamp
);

-- Create enumerated custom data type for customer table
...
CREATE TABLE sales_person (
    ...
    sales_person_id SERIAL PRIMARY KEY -- Primary key
);

-- Verify sales_person table
SELECT *
FROM sales_person;
...
ALTER TABLE prodcut_type RENAME TO product_type;
ALTER TABLE product_type RENAME COLUMN prodcut_type_id TO product_type_id;

-- Verify product_type table    
SELECT *
FROM product_type;
...
CREATE TABLE item (
    ...
    item_id SERIAL PRIMARY KEY, -- Primary key
...
CREATE TABLE sales_order (
    ...
    sales_person_id INTEGER NOT NULL, -- Foreign key
    ...
    FOREIGN KEY (sales_person_id) REFERENCES sales_person(sales_person_id) ON DELETE CASCADE
);
...
-- Change data type of zip column in customer table
ALTER TABLE customer
...
-- Change data type of zip column in sales_person table
...
-- Change data type of purchase_order_number column in sales_order table
ALTER TABLE sales_order
